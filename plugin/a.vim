...
" notice and this text are not removed. We make no guarantee about the suitability of this software for any purpose and we are not liable
...
call <SID>AddAlternateExtensionMapping('h',"c,cpp,cxx,cc,CC,ipp")
